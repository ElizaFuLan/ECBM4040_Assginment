[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-24ddc0f5d75046c5622901739e7c5dd533143b0c8e959d652212380cedb1ea36.svg)](https://classroom.github.com/a/U3aBeEY2)
...
```
Note: To avoid dataset leaking, I didn't upload the training and testing dataset in my homework, but I would show the raw directory tree of my previous folder of my homework. Thanks.
```
...
├── figures
│   ├── yh3612_gcp_work_example_screenshot_1.png
│   ├── yh3612_gcp_work_example_screenshot_2.png
│   └── yh3612_gcp_work_example_screenshot_3.png
├── kaggle_predicted.csv
├── logs
│   └── fit
│       ├── 20231024-154325
│       │   └── train
│       │       └── events.out.tfevents.1698176605.hanyuningdeMacBook-Pro.local.74069.0.v2
│       └── 20231024-154533
│           ├── train
│           │   └── events.out.tfevents.1698176733.hanyuningdeMacBook-Pro.local.74069.1.v2
│           └── validation
│               └── events.out.tfevents.1698176746.hanyuningdeMacBook-Pro.local.74069.2.v2
├── model
│   ├── task3_model
│   │   ├── assets
│   │   ├── fingerprint.pb
...
└── utils
    ├── __pycache__
    │   ├── image_generator.cpython-311.pyc
    │   ├── layer_funcs.cpython-311.pyc
    │   ├── optimizers.cpython-311.pyc
    │   └── reg_funcs.cpython-311.pyc
    ├── image_generator.py
    ├── layer_funcs.py
    ├── neuralnets
    │   ├── __pycache__
    ...
    │   │   ├── LeNet_trainer.py
    │   │   ├── __pycache__
    │   │   │   ├── model_LeNet.cpython-311.pyc
    │   │   │   ├── my_LeNet_trainer.cpython-311.pyc
    │   │   │   └── my_model_LeNet.cpython-311.pyc
    │   │   ├── model_LeNet.py
    │   │   ├── my_LeNet_trainer.py
    │   │   └── my_model_LeNet.py
    │   └── mlp.py
