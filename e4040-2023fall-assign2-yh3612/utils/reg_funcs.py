...
def bn_forward(x, gamma, beta, bn_params, mode):
    ...
    if mode == "train":
        ...
        moving_mean = decay * moving_mean + (1- decay) * sample_mean
        moving_var = decay * moving_var + (1- decay) * sample_var
        ...
        raise ValueError("Invalid mode. Expected 'train' or 'test', but got {}".format(mode))
